<div class="relative" x-data="{ open: @entangle('showDropdown') }">
    ...
    <button
        @click="open = !open"
        type="button"
        class="relative fi-icon-btn fi-color-gray fi-icon-btn-size-lg"
    >
        <x-heroicon-o-bell class="h-6 w-6 text-gray-700" />


        @if($unreadNotificationsCount > 0)
            <span class="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-danger-600 text-xs font-medium text-white">
