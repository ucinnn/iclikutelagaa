...
use App\Filament\Pages\Actions\EditAction;
...
protected static string $view = 'filament.pages.custom-view-env-page';
    ...
    {
        return Filament::auth()->user()?->role === 'superadmin';
    }
